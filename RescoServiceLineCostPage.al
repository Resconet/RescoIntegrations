page 50104 RescoServiceLineCost
{
    APIGroup = 'RescoIntegrations';
    APIPublisher = 'Resco';
    APIVersion = 'v2.0';
    Caption = 'RescoServiceLineCost';
    DelayedInsert = true;
    EntityName = 'RescoServiceLineCost';
    EntitySetName = 'RescoServiceLineCost';
    PageType = API;
    SourceTable = "Service Line";
    SourceTableView = WHERE("Type" = CONST(Cost), "Document Type" = CONST(Order));
